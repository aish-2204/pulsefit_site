...
pulsefit_track_product_visit('corporate-wellness');

$product = $products['corporate-wellness'];
$navBase = '../';
?><!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main class="container page">
    ...
    <section class="stack">
      ...
      <article class="card">
        <h2>For teams and workplaces</h2>
        <p class="muted"><?php echo htmlspecialchars($product['description'], ENT_QUOTES); ?></p>
        <ul class="feature-list">
          <li>On-site or virtual group fitness options</li>
          <li>Education sessions on movement and nutrition</li>
          <li>Simple monthly reporting on participation</li>
        </ul>
      </article>
