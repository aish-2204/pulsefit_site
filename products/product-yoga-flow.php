...
pulsefit_track_product_visit('yoga-flow');

$product = $products['yoga-flow'];
$navBase = '../';
?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <section class="stack">
      ...
      <article class="card">
        ...
        <ul class="feature-list">
          <li>Guided yoga flows for all experience levels</li>
          <li>Dedicated mobility and recovery sessions</li>
          <li>Breathing and relaxation-focused classes</li>
        </ul>
      </article>
