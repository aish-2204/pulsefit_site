...
pulsefit_track_product_visit('recovery-lab');

$product = $products['recovery-lab'];
$navBase = '../';
?><!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main class="container page">
    ...
    <section class="stack">
      <img src="../assets/Yoga.jpg" alt="<?php echo htmlspecialchars($product['name'], ENT_QUOTES); ?>" class="card-image" />
      <article class="card">
        <h2>Recovery-focused sessions</h2>
        <p class="muted"><?php echo htmlspecialchars($product['description'], ENT_QUOTES); ?></p>
        <ul class="feature-list">
          <li>Guided stretching and mobility work</li>
          <li>Breathing and relaxation drills</li>
          <li>Ideal for rest days and deload weeks</li>
        </ul>
      </article>
