...
pulsefit_track_product_visit('app-membership');

$product = $products['app-membership'];
$navBase = '../';
?><!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main class="container page">
    ...
    <section class="stack">
      ...
      <article class="card">
        <h2>Train anywhere with PulseFit</h2>
        <p class="muted"><?php echo htmlspecialchars($product['description'], ENT_QUOTES); ?></p>
        <ul class="feature-list">
          <li>Structured programs for home or gym training</li>
          <li>Progress and habit tracking in one place</li>
          <li>Access to new training blocks as they release</li>
        </ul>
      </article>
