...
pulsefit_track_product_visit('gym-access');

$product = $products['gym-access'];
$navBase = '../';
?><!DOCTYPE html>
<html lang="en">
<head>
...
<body>
  ...
  <main class="container page">
    ...
    <section class="stack">
      <img src="../assets/gym.jpg" alt="<?php echo htmlspecialchars($product['name'], ENT_QUOTES); ?>" class="card-image" />
      <article class="card">
        <h2>What is included</h2>
        <p class="muted"><?php echo htmlspecialchars($product['description'], ENT_QUOTES); ?></p>
        <ul class="feature-list">
          <li>Unlimited access to the PulseFit training floor</li>
          <li>Strength, cardio, and functional training zones</li>
          <li>Workout logging and progress tracking in the app</li>
        </ul>
      </article>
